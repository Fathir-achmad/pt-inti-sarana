            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              >
                ...
                <p className="text-gray-600 leading-relaxed">
                  PT INTI SARANA, berdiri pada tahun 2012, adalah perusahaan yang bergerak dalam solusi teknik mekanikal, elektrikal, dan plumbing.
                </p>
                <p className="text-gray-600 leading-relaxed">
